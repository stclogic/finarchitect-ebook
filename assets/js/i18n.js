...
const SITE_I18N = {
  ko: {
    ...
    'insight.read': '읽기 →',
    'ins10.title': '"AI가 10년 안에 인류를 멸망시킨다" 경고, 우리는 무엇을 해야 하나',
    'ins9.title': '모두가 등을 돌린 그 순간, 시장은 조용히 손을 바꾼다 — 비트코인 대전환',
    'ins8.title': '캐나다가 독일을 택한 이유 — 60조 잠수함 사업과 \'팀 코리아\'의 합리적 투자 철회',
    'ins7.title': '"100만원 벌어와" 했더니 진짜 벌어온 AI — 자동화의 현실과 AI 시대 생존법',
    'ins6.title': '이번 주 빅테크 실적 — 6천억 달러 AI 투자는 드디어 돈이 되는가',
    'ins5.title': '전쟁은 사업이다 — 미-이란 분쟁에서 읽는 트럼프의 머니게임',
    ...
    'pricing.passkey.badge': '⭐ 가장 인기',
    'pricing.passkey.name': '평생 패스키',
    'pricing.passkey.desc': '현재 및 향후 출판되는 모든 유료 eBook을 평생 무제한 열람',
    'pricing.passkey.period': '/ 평생',
    'pricing.passkey.f1': '현재 출판된 모든 유료 eBook 전체 열람',
    'pricing.passkey.f2': '향후 신규 출판 eBook 자동 포함',
    'pricing.passkey.f3': '한국어 · English · 日本語 3개국어',
    'pricing.passkey.f4': '서식 라이브러리 평생 무료 이용',
    'pricing.passkey.f5': '업데이트 콘텐츠 자동 반영',
    'pricing.passkey.success': '<strong>결제 완료!</strong><br>평생 패스키가 활성화되었습니다.<br>모든 eBook에 즉시 접근할 수 있습니다.',
    'pricing.loading': '결제 버튼 로딩 중...',
    'pricing.plan3.name': '금융 컨설팅',
    'pricing.plan3.desc': '프로젝트별 맞춤 금융 구조 설계 · PF · SPV · STO 전략 수립',
    'pricing.plan3.range': '$0,000 ~ $000,000',
    ...
    'pricing.book.title': '개별 도서 구입',
    'pricing.book.desc': '원하는 책만 골라 개별 구매할 수 있습니다. 각 eBook 페이지에서 바로 결제하세요.<br><span style="color:var(--text3); font-size:0.8rem;">구조로 돈을 설계하는 사람들 $49 · HNWI 코드 $49</span>',
    'pricing.book.cta': '라이브러리 바로가기 →',
  ...
  en: {
    ...
    'insight.read': 'Read →',
    'ins10.title': '"AI could wipe out humanity within 10 years" — what should we do?',
    'ins9.title': 'When Everyone Looks Away, the Market Quietly Changes Hands — the Bitcoin Great Pivot',
    'ins8.title': 'Why Canada Chose Germany — the ₩60 Trillion Submarine Deal and Team Korea\'s Rational Retreat',
    'ins7.title': '"Go Make Me $1,000." And the AI Actually Did — How Far Automation Goes, and How to Survive It',
    'ins6.title': 'Big Tech Earnings This Week — Is the $600 Billion AI Bet Finally Paying Off?',
    'ins5.title': 'War Is Business — Trump\'s Money Game in the US–Iran Conflict',
    ...
    'pricing.passkey.badge': '⭐ Most Popular',
    'pricing.passkey.name': 'Lifetime Pass',
    'pricing.passkey.desc': 'Unlimited lifetime access to all current and future premium eBooks',
    'pricing.passkey.period': '/ lifetime',
    'pricing.passkey.f1': 'Full access to all currently published premium eBooks',
    'pricing.passkey.f2': 'Future new eBooks automatically included',
    'pricing.passkey.f3': 'Korean · English · Japanese (3 languages)',
    'pricing.passkey.f4': 'Lifetime free access to Forms Library',
    'pricing.passkey.f5': 'Content updates automatically reflected',
    'pricing.passkey.success': '<strong>Payment Complete!</strong><br>Your Lifetime Pass has been activated.<br>You now have instant access to all eBooks.',
    'pricing.loading': 'Loading payment button...',
    ...
    'pricing.book.title': 'Buy Individual Books',
    'pricing.book.desc': 'Pick only the books you want and buy them individually. Check out directly on each eBook page.<br><span style="color:var(--text3); font-size:0.8rem;">Designing Money with Structure $49 · The HNWI Code $49</span>',
    'pricing.book.cta': 'Go to Library →',
    'pricing.consult.done': '📩',
  ...
  ja: {
    ...
    'insight.read': '読む →',
    'ins10.title': '「AIは10年以内に人類を滅ぼしうる」— 私たちは何をすべきか',
    'ins9.title': '皆が目を背けたその瞬間、市場は静かに手を替える——ビットコイン大転換',
    'ins8.title': 'カナダがドイツを選んだ理由——60兆ウォン潜水艦事業と「チーム・コリア」の合理的な投資撤退',
    'ins7.title': '「100万円稼いでこい」と言ったら本当に稼いできたAI——自動化の現実とAI時代の生き残り方',
    'ins6.title': '今週のビッグテック決算——6,000億ドルのAI投資はついに実を結ぶのか',
    'ins5.title': '戦争はビジネスだ——米・イラン紛争に読むトランプのマネーゲーム',
    ...
    'pricing.passkey.badge': '⭐ 最も人気',
    'pricing.passkey.name': '生涯パスキー',
    'pricing.passkey.desc': '現在および今後出版されるすべての有料eBookを生涯無制限で閲覧',
    'pricing.passkey.period': '/ 生涯',
    'pricing.passkey.f1': '現在出版中のすべての有料eBook全閲覧',
    'pricing.passkey.f2': '今後の新規出版eBook自動含む',
    'pricing.passkey.f3': '韓国語 · English · 日本語 3言語',
    'pricing.passkey.f4': '書式ライブラリ生涯無料利用',
    'pricing.passkey.f5': 'アップデートコンテンツ自動反映',
    'pricing.passkey.success': '<strong>決済完了！</strong><br>生涯パスキーが有効化されました。<br>すべてのeBookに即時アクセスできます。',
    'pricing.loading': '決済ボタン読み込み中...',
    ...
    'pricing.book.title': '個別に本を購入',
    'pricing.book.desc': '欲しい本だけを選んで個別に購入できます。各eBookページで直接お支払いください。<br><span style="color:var(--text3); font-size:0.8rem;">構造でお金を設計する人々 $49 · HNWIコード $49</span>',
    'pricing.book.cta': 'ライブラリへ →',
    'pricing.consult.done': '📩',
