...
const SITE_I18N = {
  ko: {
    ...
    'pricing.footer.note': '모든 결제는 PayPal(Google Pay · Apple Pay · 신용카드 포함)을 통해 안전하게 처리됩니다. · 환불 정책: 콘텐츠 열람 전, 기술적 오류·미게재·중복결제 등 당사 귀책 사유 시 전액 환불',
  ...
  en: {
    ...
    'pricing.footer.note': 'All payments processed securely via PayPal (Google Pay · Apple Pay · Credit Card included). · Refund policy: Full refund before content access, or in cases of technical failure, unavailable content, or duplicate payment.',
    'pricing.consult.done': '📩',
  ...
  ja: {
    ...
    'pricing.footer.note': '全ての決済はPayPal（Google Pay・Apple Pay・クレジットカード含む）で安全に処理されます。· 返金ポリシー: コンテンツ閲覧前、技術的障害・未掲載・重複決済等の当社帰責事由の場合は全額返金',
    'pricing.consult.done': '📩',
